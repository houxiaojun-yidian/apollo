...
(function (V, W, v) {
    ...
    function yc(a, b) {
        ...
        var e = {}, f = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/, g = /(([\w\-]+)(?:\:([^;]+))?;?)/,
            h = Wd("ngSrc,ngSrcset,src,srcset"), k = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, l = /^(on[a-z]+|formaction)$/,
            m = X();
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, m, s, t, S, w, B, L) {
            ...
            function Y(a, b, c, d, e, f, g, h) {
                var k = [], l, n, B = b[0], t = a.shift(),
                    s = Nb(t, {templateUrl: null, transclude: null, replace: null, $$originalDirective: t}),
    ...
    function ef() {
        this.$get = ["$rootScope", "$window", "$q", "$$q", "$browser", function (a, b, d, c, e) {
            function f(f, k, l, m) {
                ...
                var x = 4 < arguments.length, C = x ? ya.call(arguments, 4) : [], p = b.setInterval,
                    y = b.clearInterval, q = 0, s = z(m) && !m, t = (s ? c : d).defer(), S = t.promise;
                l = z(l) ? l : 0;
    ...
    function nf() {
        ...
        this.$get = ["$filter", function (c) {
            ...
            var x = Da().noUnsafeEval, C = {csp: x, expensiveChecks: !1, literals: pa(d)},
                K = {csp: x, expensiveChecks: !0, literals: pa(d)}, y = !1;
    ...
    function tf() {
        this.$get = ["$window", "$document", function (a, b) {
            var d = {}, c = ba((/android (\d+)/.exec(I((a.navigator || {}).userAgent)) || [])[1]),
                e = /Boxee/i.test((a.navigator ||
                    {}).userAgent), f = b[0] || {}, g, h = /^(Moz|webkit|ms)(?=[A-Z])/, k = f.body && f.body.style,
                l = !1, m = !1;
            if (k) {
    ...
    var ug = /^\/(.+)\/([a-z]*)$/, ta = Object.prototype.hasOwnProperty, I = function (a) {
        ...
        }, za, H, qa, ya = [].slice, Vf = [].splice, vg = [].push, fa = Object.prototype.toString,
        oc = Object.getPrototypeOf, Ca = O("ng"), ca = V.angular || (V.angular = {}), Qb, nb = 0;
    za = W.documentMode;
    E.$inject = [];
    Xa.$inject = [];
    var M = Array.isArray,
        ...
        pb = function () {
            ...
            return pb.name_ = e
        }, Yd = /:/g, Na = ["ng-", "data-ng-", "ng:", "x-ng-"], ce = /[A-Z]/g, wc = !1, bb = 3,
        ge = {full: "1.5.1", major: 1, minor: 5, dot: 1, codeName: "equivocal-sophistication"};
    Y.expando = "ng339";
    var fb = Y.cache = {}, If = 1;
    Y._data = function (a) {
    ...
    var Df = /([\:\-\_]+(.))/g, Ef = /^moz([A-Z])/, wb = {
        ...
        }, Sb = O("jqLite"), Hf = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, Rb = /<|&#?\w+;/, Ff = /<([\w:-]+)/,
        Gf = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, ja = {
    ...
    var gg = Object.prototype.valueOf, xa = O("$sce"),
        da = {HTML: "html", CSS: "css", URL: "url", RESOURCE_URL: "resourceUrl", JS: "js"}, ga = O("$compile"),
        $ = W.createElement("a"), sd = sa(V.location.href);
    td.$inject = ["$document"];
    Fc.$inject = ["$provide"];
    var Ad = 22, zd = ".", fc = "0";
    ud.$inject = ["$locale"];
    ...
    var Md = function (a) {
        ...
        Eg = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/, Nd = /^(\d{4,})-(\d{2})-(\d{2})$/,
        Od = /^(\d{4,})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, jc = /^(\d{4,})-W(\d\d)$/,
        Pd = /^(\d{4,})-(\d\d)$/, Qd = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Fd = X();
    ...
    var ye = ["$animate", "$compile", function (a, b) {
        ...
        }, mb = "ng-valid", Id = "ng-invalid", Ua = "ng-pristine", Ib = "ng-dirty", Kd = "ng-pending", lb = O("ngModel"),
        ...
        Je = ["$compile", "$parse", function (a, b) {
            function d(a, c, d) {
                ...
                var v = a && b(a) || c, y = r && b(r), q = r ? function (a, b) {
                        ...
                        return q(a, E(a, b))
                    }, t = b(m[2] || m[1]), z = b(m[3] || ""), w = b(m[4] || ""), B = b(m[8]), u = {},
                    E = p ? function (a, b) {
                        u[p] = b;
                        u[n] = a;
                        return u
                ...
                return {
                    trackBy: r, getTrackByValue: s, getWatchables: b(B, function (a) {
                        ...
                        for (var a = [], b = {}, c = B(d) || [], f = l(c), g = f.length, m = 0; m < g; m++) {
                            var n = c === f ? m : f[m], p = E(c[n], n), x = v(d, p), n = q(x, p), y = t(d, p),
                                u = z(d, p), p = w(d, p), x = new e(n, x, y, u, p);
                            a.push(x);
                            b[n] = x
                        }
                        return {
            ...
            return {
                link: function (f, g, h) {
                    ...
                    var l = h.count, m = h.$attr.when && g.attr(h.$attr.when), n = h.offset || 0, r = f.$eval(m) || {},
                        v = {}, z = b.startSymbol(), y = b.endSymbol(), q = z + l + "-" + n + y, s = ca.noop,
                        t;
                    p(h, function (a, b) {
                        var c = e.exec(b);
